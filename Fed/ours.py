...
class Ours(FedDistill):
    ...
    def run(self):
        ...
        for round in range(self.args.n_comm_round):
            ...
            for client_idx in party_list_this_round:
                ...
                best_img_syn, best_lab_syn = self.L2D(local_nets[client_idx], indices_class, image_syn, label_syn, train_dl, val_dl)
    ...
    def L2D(self, net, indices_class, image_syn, label_syn, train_dl, val_dl):
